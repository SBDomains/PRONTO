...
This mechanism has been integrated into Bitcore-Node-PRONTO which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/prontopay/insight-api-pronto#web-socket-api](https://github.com/prontopay/insight-api-pronto#web-socket-api)
* API: [https://github.com/prontopay/insight-api-pronto#instantsend-transactions](https://github.com/prontopay/insight-api-pronto#instantsend-transactions)
...
By default, the PRONTO Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the PRONTO Core daemon:

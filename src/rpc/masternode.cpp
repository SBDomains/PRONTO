...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print PRONTO address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "pronto",               "masternode",             &masternode,             true,  {} },
    { "pronto",               "masternodelist",         &masternodelist,         true,  {} },
    { "pronto",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "pronto",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "pronto",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "pronto",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};

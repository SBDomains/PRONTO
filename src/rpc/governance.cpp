...
UniValue gobject(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp  ||
        ...
        throw std::runtime_error(
                ...
                "  vote-conf          - Vote on a governance object by masternode configured in pronto.conf\n"
    ...
    */
    ...
    if(strCommand == "vote-conf")
    {
        ...
        if(!fMnFound) {
            ...
            resultsObj.push_back(Pair("pronto.conf", statusObj));
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    /* PRONTO features */
    { "pronto",               "getgovernanceinfo",      &getgovernanceinfo,      true,  {} },
    { "pronto",               "getsuperblockbudget",    &getsuperblockbudget,    true,  {"index"} },
    { "pronto",               "gobject",                &gobject,                true,  {} },
    { "pronto",               "voteraw",                &voteraw,                true,  {} },

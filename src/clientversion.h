...
//! These need to be macros, as clientversion.cpp's and pronto*-res.rc's voodoo requires it
...
/**
 * prontod-res.rc includes this file, but it cannot cope with real c++ code.

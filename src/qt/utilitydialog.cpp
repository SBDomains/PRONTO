    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  pronto-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the PRONTO in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 PRONTO, 0.1 PRONTO, 1 PRONTO and 10 PRONTO -- sort of like the paper money you use every day.</li> \

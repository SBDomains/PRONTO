    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("PRONTO-light"), QVariant("light"));
    ui->theme->addItem(QString("PRONTO-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("PRONTO-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("PRONTO-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("PRONTO-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("PRONTO-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("PRONTO-traditional"), QVariant("trad"));

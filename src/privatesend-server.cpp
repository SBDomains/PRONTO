...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, const std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all PRONTO related functionality
...
/*
    ...
    allow endless transaction that would bloat PRONTO and make it unusable. To
